...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleNoSuchElementFoundException(PublishingException itemNotFoundException, WebRequest request) {
